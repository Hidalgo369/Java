...
public class TestIncorrectos {
	public static void main(String[] args) {
		...
		for (int i = 0; i < telefonosIncorrectos.size(); i++) {// Modifiqué el límite del for para que sea menor que el
																// número elemento del arreglo
			totalNumeros++; // De igual manera en el contador, ya que había un error de lógica, ya que al
							// agregar 2 telefonos con errores, me imprimía 3 en consola
